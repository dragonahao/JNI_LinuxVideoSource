...
${OBJECTDIR}/src/org_interactiverobotics_video_impl_LinuxVideoSource.o: src/org_interactiverobotics_video_impl_LinuxVideoSource.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/org_interactiverobotics_video_impl_LinuxVideoSource.o src/org_interactiverobotics_video_impl_LinuxVideoSource.c
